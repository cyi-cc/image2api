...
func (h *UserGenerationHandler) VideoPresets(c *gin.Context) {
	c.JSON(http.StatusOK, gin.H{
		"data": []gin.H{
			...
			{
				"key":                  "leonardo-seedance-fast",
				"label":                "Leonardo Seedance 2.0 Fast",
				"type":                 "video",
				"provider":             "leonardo",
				"durations":            []string{"4s", "5s", "6s", "7s", "8s", "9s", "10s", "11s", "12s", "13s", "14s", "15s"},
				"ratios":               []string{"16:9", "9:16"},
			...
			{
				"key":                  "leonardo-seedance-2.0",
				"label":                "Leonardo Seedance 2.0",
				"type":                 "video",
				"provider":             "leonardo",
				"durations":            []string{"4s", "5s", "6s", "7s", "8s", "9s", "10s", "11s", "12s", "13s", "14s", "15s"},
				"ratios":               []string{"16:9", "9:16"},
			...
			{
				"key":                  "leonardo-seedance-mini",
				"label":                "Leonardo Seedance 2.0 Mini",
				"type":                 "video",
				"provider":             "leonardo",
				"durations":            []string{"4s", "5s", "6s", "7s", "8s", "9s", "10s", "11s", "12s", "13s", "14s", "15s"},
				"ratios":               []string{"16:9", "9:16"},
			...
			{
				"key":                  "leonardo-minimax-h3",
				"label":                "Leonardo MiniMax H3",
				"type":                 "video",
				"provider":             "leonardo",
			...
			{
				"key":                  "leonardo-happy-horse-1.1",
				"label":                "Leonardo Happy Horse 1.1",
				"type":                 "video",
				"provider":             "leonardo",
				"durations":            []string{"3s", "4s", "5s", "6s", "7s", "8s", "9s", "10s", "11s", "12s", "13s", "14s", "15s"},
				"ratios":               []string{"16:9", "4:3", "1:1", "3:4", "9:16"},
				"resolutions":          []string{"720p", "1080p"},
				"max_reference_images": 9,
...
func (h *UserGenerationHandler) catalogEntries(c *gin.Context) ([]gin.H, error) {
	items := []gin.H{
		...
		},
		{
			...
			"max_reference_images": 2,
			"reference_mode":       "frame",
			"description":          "Leonardo Seedance 2.0 Fast",
		},
		{
			"id":                   "leonardo-seedance-2.0",
			"provider":             "leonardo",
			"type":                 "video",
			"ratios":               []string{"16:9", "9:16"},
			"resolutions":          []string{"720p", "1080p"},
			...
			"max_reference_images": 2,
			"reference_mode":       "frame",
			"description":          "Leonardo Seedance 2.0",
		},
		{
			"id":                   "leonardo-seedance-mini",
			"provider":             "leonardo",
			"type":                 "video",
			"ratios":               []string{"16:9", "9:16"},
			"resolutions":          []string{"720p"},
			...
			"max_reference_images": 2,
			"reference_mode":       "frame",
			"description":          "Leonardo Seedance 2.0 Mini",
		},
		{
			"id":                   "leonardo-minimax-h3",
			"provider":             "leonardo",
			"type":                 "video",
			"ratios":               []string{"21:9", "16:9", "4:3", "1:1", "3:4", "9:16"},
			"resolutions":          []string{"2K"},
			...
			"max_reference_images": 2,
			"reference_mode":       "frame",
			"description":          "Leonardo MiniMax H3 video with native audio",
		},
		{
			"id":                   "leonardo-happy-horse-1.1",
			"provider":             "leonardo",
			"type":                 "video",
			"ratios":               []string{"16:9", "4:3", "1:1", "3:4", "9:16"},
			"resolutions":          []string{"720p", "1080p"},
			...
			"max_reference_images": 9,
			"reference_mode":       "asset",
			"description":          "Leonardo Happy Horse 1.1 video with native audio",
		},
		{
...
func (h *UserGenerationHandler) publicModels() ([]gin.H, error) {
	items := []gin.H{
		...
		},
		{
			...
			"ratios":      []string{"21:9", "16:9", "4:3", "1:1", "3:4", "9:16"},
			"resolutions": []string{"2K"},
			"description": "Leonardo MiniMax H3 video",
			"stub":        false,
		},
		{
			"id":          "leonardo-happy-horse-1.1",
			...
			"ratios":      []string{"16:9", "4:3", "1:1", "3:4", "9:16"},
			"resolutions": []string{"720p", "1080p"},
			"description": "Leonardo Happy Horse 1.1 video",
			"stub":        false,
		},
		{
			"id":          "runway-gen4-turbo",
